...
我最近写 README/技术方案也经常卡在这一步：AI 生成 Mermaid/PlantUML 很快，但真正要放进文档前，还是要找地方预览、修语法、导出 SVG/PNG。
...
现在大模型确实很适合先生成图表文本，但它不会帮你保证“复制进 README 就能渲染”。尤其 Mermaid 一旦语法有点问题，直接放文档里才发现会很烦。
...
如果团队已经在用 Mermaid 写架构/流程图，可以考虑把 AI 生成代码和预览工具拆开：AI 负责初稿，预览工具负责渲染、修错、导出。
...
This is exactly the gap I kept seeing with AI-generated diagrams: the model can write Mermaid or PlantUML, but it does not tell you whether the output actually renders. I built a small browser-first tool for that preview/export step: https://diagrampreview.com
